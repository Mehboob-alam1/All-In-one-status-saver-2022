...
import com.dotaustere.status.adapter.ShowImagesAdapter;
import com.dotaustere.status.databinding.ActivityFullViewBinding;
...
import static com.dotaustere.status.util.Utils.shareImage;
import static com.dotaustere.status.util.Utils.shareImageVideoOnWhatsapp;
import static com.dotaustere.status.util.Utils.shareVideo;
