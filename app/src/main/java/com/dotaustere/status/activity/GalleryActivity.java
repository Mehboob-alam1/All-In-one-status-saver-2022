...
import com.dotaustere.status.databinding.ActivityGalleryBinding;
import com.dotaustere.status.fragment.AllinOneGalleryFragment;
import com.dotaustere.status.fragment.FBDownloadedFragment;
import com.dotaustere.status.fragment.InstaDownloadedFragment;
import com.dotaustere.status.fragment.LikeeDownloadedFragment;
import com.dotaustere.status.fragment.RoposoDownloadedFragment;
import com.dotaustere.status.fragment.SharechatDownloadedFragment;
import com.dotaustere.status.fragment.SnackVideoDownloadedFragment;
import com.dotaustere.status.fragment.TikTokDownloadedFragment;
import com.dotaustere.status.fragment.TwitterDownloadedFragment;
import com.dotaustere.status.fragment.WhatsAppDowndlededFragment;
import com.dotaustere.status.util.AdsUtils;
