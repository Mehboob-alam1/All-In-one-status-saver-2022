...
import com.dotaustere.status.adapter.StoriesListAdapter;
import com.dotaustere.status.adapter.UserListAdapter;
import com.dotaustere.status.api.CommonClassForAPI;
import com.dotaustere.status.databinding.ActivityInstagramBinding;
import com.dotaustere.status.interfaces.UserListInterface;
import com.dotaustere.status.model.Edge;
import com.dotaustere.status.model.EdgeSidecarToChildren;
import com.dotaustere.status.model.FBStoryModel.NodeModel;
import com.dotaustere.status.model.ResponseModel;
import com.dotaustere.status.model.story.FullDetailModel;
import com.dotaustere.status.model.story.StoryModel;
...
import static com.dotaustere.status.util.Utils.RootDirectoryInsta;
